		...
		<table>
			...
			<%
			    try {
			        ...
			        ResultSet rs = stmt.executeQuery("SELECT * FROM TBL_PATIENT_202004");
			        while(rs.next()) {
			            ...
			            if ("M".equals(rs.getString(4))) {			            	
			            	out.println("<td>남</td>");
			            } else {
			            	out.println("<td>여</td>");
			            }
			            out.println("<td>" + rs.getString(5) + "-" + rs.getString(6) + "-" + rs.getString(7) + "</td>");
			            if ("10".equals(rs.getString(8))) {			            	
			            	out.println("<td>서울</td>");
			            } else if ("20".equals(rs.getString(8))) {
			            	out.println("<td>경기</td>");
			            } else if ("30".equals(rs.getString(8))) {
